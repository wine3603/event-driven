...
void vAttentionManager::generateGaborFilter(Matrix &filterMap, int gaborFilterSize, double A, double f,
...
void vAttentionManager::drawBoundingBox(ImageOf<PixelBgr> &image, int topRow, int topCol,
