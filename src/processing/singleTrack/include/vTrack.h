...
private:
    ...
    //the remote procedure port for sending lock command to eventClustering
    yarp::os::RpcClient     rpcPortClient;

    //for helping with timestamp wrap around
    emorph::vtsHelper unwrapper;
    
    //for storing the response of the rpc server from the eventClustering module
...
public:
    ...
    //void    setThrNumAE(int thrNumAE);
    void    lockTracker(const yarp::os::Bottle &command, yarp::os::Bottle &reply);
